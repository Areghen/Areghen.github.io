...
### 2. [관련자료](#관련-자료)
### 3. [대표 이미지](#대표-이미지)
### 3. [갤러리(Gallery) 구성 요소](#갤러리gallery-구성-요소)
### 4. [게임 오브젝트 분해 및 게임 시스템 디자인](#게임-오브젝트-분해-및-게임-시스템-디자인)
### 5. [요구사항 & 흐름도](#요구사항--흐름도)
### 6. [6주 요구사항](#6주-요구사항)
# [컨셉]
## 메인 컨셉 : 탈출
...
### 3. 서브컨셉 : 배경
-안개 이펙트 오브젝트와 어두운 빛을 적절히 조화하여 몽환적인 배경을 연출합니다.

### 4. 서브컨셉 : 공포 유발 장식
-조각상, 그림, 화분등 미술관에서 흔히 볼수있는 오브젝트와, 공포를 유발할 수 있는 기괴한 혹은 뒤틀린 조각상, 그림을 배치합니다.

### 5. 서브컨셉: 멘탈
-사람의 정신은 한번 무너지면 특별한 상황이 일어나지 않는 이상 회복하기 쉽지 않다는걸 표현하기 위해서 선정했습니다.
